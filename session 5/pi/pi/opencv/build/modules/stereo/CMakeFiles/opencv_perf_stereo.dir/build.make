...
bin/opencv_perf_stereo: lib/libopencv_stereo.so.4.0.1
bin/opencv_perf_stereo: lib/libopencv_calib3d.so.4.0.1
bin/opencv_perf_stereo: 3rdparty/lib/libtegra_hal.a
bin/opencv_perf_stereo: lib/libopencv_features2d.so.4.0.1
bin/opencv_perf_stereo: lib/libopencv_flann.so.4.0.1
bin/opencv_perf_stereo: lib/libopencv_highgui.so.4.0.1
bin/opencv_perf_stereo: lib/libopencv_videoio.so.4.0.1
bin/opencv_perf_stereo: lib/libopencv_imgcodecs.so.4.0.1
bin/opencv_perf_stereo: lib/libopencv_imgproc.so.4.0.1
bin/opencv_perf_stereo: lib/libopencv_core.so.4.0.1
